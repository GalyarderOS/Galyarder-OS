...
export function useCommunicationAI() {
  ...
  const optimizeVoice = (content: string, targetTone: string) => {
    ...
    return {
      suggestion: optimizations[targetTone as keyof typeof optimizations] || 'Maintain consistency with your established voice.',
