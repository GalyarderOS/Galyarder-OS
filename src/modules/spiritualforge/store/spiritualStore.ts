...
import { SpiritualState, Prayer, SpiritualActivity, TafsirEntry, SpiritualGoal } from '../types'
...
const mockActivities: SpiritualActivity[] = [
  {
    id: '1',
    type: 'dhikr',
    title: 'Morning Dhikr',
...
const mockTafsirEntries: TafsirEntry[] = [
  {
    id: '1',
    surah: 2,
    ayah: 255,
...
const mockSpiritualGoals: SpiritualGoal[] = [
  {
    id: '1',
  ...
  persist(
    (set, get) => ({
      ...
      addActivity: (activity) => {
        const newActivity: SpiritualActivity = {
          ...activity,
      ...
      updateTafsirEntry: (id, updates) => {
        set((state) => ({
          tafsirEntries: state.tafsirEntries.map(entry =>
