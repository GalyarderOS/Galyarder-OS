...
export function CareerCommand() {
    return (_jsxs("div", { className: "space-y-8", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: "mb-8", children: [_jsx("h1", { className: "text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent", children: "Career Command" }), _jsx("p", { className: "text-slate-400 mt-2", children: "Advance your career with skill development and income optimization" })] }), _jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-8", children: [_jsx(SkillMapBoard, {}), _jsx(IncomeStreamTracker, {})] })] }));
}
