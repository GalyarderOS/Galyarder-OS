...
import { EnvironmentState, EnvironmentMode, Device, AmbientProfile } from '../types'

const mockModes: EnvironmentMode[] = [
  {
    id: '1',
    name: 'Deep Focus',
...
const mockAmbientProfiles: AmbientProfile[] = [
  {
    id: '1',
  ...
  persist(
    (set, get) => ({
      ...
      updateAmbientProfile: (id, updates) => {
        set((state) => ({
          ambientProfiles: state.ambientProfiles.map(profile =>
