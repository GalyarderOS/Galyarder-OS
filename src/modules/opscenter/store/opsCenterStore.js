...
export const useOpsCenterStore = create()(persist((set, get) => ({
    ...
    addTask: (task) => {
        ...
        set((state) => ({
            ...
            projects: state.projects.map(project => project.id === task.projectId
    ...
    deleteTask: (id) => {
        ...
        if (taskToDelete) {
            set((state) => ({
                ...
                projects: state.projects.map(project => project.id === taskToDelete.projectId
    ...
    updateWorkflow: (id, updates) => {
        set((state) => ({
            workflows: state.workflows.map(workflow => workflow.id === id
