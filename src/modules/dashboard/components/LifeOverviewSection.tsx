...
export function LifeOverviewSection() {
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-white mb-6">Life Overview</h2>
        ...
        {metrics.map((metric, index) => (
          ...
          >
            ...
            <div className="text-2xl font-bold text-white mb-1">
              {metric.value}{metric.label.includes('Score') || metric.label.includes('Progress') || metric.label.includes('Energy') ? '%' : ''}
            </div>
            ...
            <div className="mt-3 bg-slate-700 rounded-full h-2">
              <motion.div
                ...
                className={`h-2 rounded-full bg-gradient-to-r ${
                  metric.color.includes('emerald') ? 'from-emerald-500 to-emerald-400' :
